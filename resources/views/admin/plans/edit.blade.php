    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.plans.update", [$plan->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_monthly') ? 'is-invalid' : '' }}" type="number" name="price_monthly" id="price_monthly" value="{{ old('price_monthly', $plan->price_monthly) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_yearly') ? 'is-invalid' : '' }}" type="number" name="price_yearly" id="price_yearly" value="{{ old('price_yearly', $plan->price_yearly) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" name="type" id="type" required>
                    ...
                    @foreach(App\Models\Plan::TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('type', $plan->type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('type'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('word_limit') ? 'is-invalid' : '' }}" type="number" name="word_limit" id="word_limit" value="{{ old('word_limit', $plan->word_limit) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('image_limit') ? 'is-invalid' : '' }}" type="number" name="image_limit" id="image_limit" value="{{ old('image_limit', $plan->image_limit) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pp_monthly_plan') ? 'is-invalid' : '' }}" type="text" name="pp_monthly_plan" id="pp_monthly_plan" value="{{ old('pp_monthly_plan', $plan->pp_monthly_plan) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pp_yearly_plan') ? 'is-invalid' : '' }}" type="text" name="pp_yearly_plan" id="pp_yearly_plan" value="{{ old('pp_yearly_plan', $plan->pp_yearly_plan) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stripe_monthly_plan') ? 'is-invalid' : '' }}" type="text" name="stripe_monthly_plan" id="stripe_monthly_plan" value="{{ old('stripe_monthly_plan', $plan->stripe_monthly_plan) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stripe_yearly_plan') ? 'is-invalid' : '' }}" type="text" name="stripe_yearly_plan" id="stripe_yearly_plan" value="{{ old('stripe_yearly_plan', $plan->stripe_yearly_plan) }}">
